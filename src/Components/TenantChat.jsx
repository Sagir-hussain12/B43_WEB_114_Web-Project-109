  ...
  const messages = [
    {
      id: 1,
      sender: 'tenant',
      message: 'Hi, I wanted to ask about the maintenance request I submitted yesterday.',
      timestamp: '10:30 AM',
    },
    {
      id: 2,
      sender: 'landlord',
      message: 'Hello! Yes, I received it. The plumber is scheduled for tomorrow morning between 9-11 AM. Will you be available?',
      timestamp: '10:32 AM',
    },
    {
      id: 3,
      sender: 'tenant',
      message: 'Yes, I ll be home during that time. Thank you for the quick response!',
      timestamp: '10:33 AM',
    },
    {
      id: 4,
